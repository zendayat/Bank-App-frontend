...
const Hero = () => {
    return (
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className=' w-[40%] h-[35%] absolute top-0 z-[0] pink__gradient' />
        <div className=' w-[80%] h-[80%] absolute top-0 z-[1] rounded-full bottom-40  white__gradient' />
        <div className=' w-[50%] h-[50%] absolute right-20 bottom-20 z-[0] blue__gradient' />
      </div>
